<header class="header">
    <div class="logo-container">
        <a href="../4.3.0" class="logo"> <img src="{{ asset('assets/images/logos/icon2.png') }}" width="75"
                        ...
                        <ul>
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="{{ asset('assets/img/!sample-user.jpg') }}" alt="Joseph Doe Junior"
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="{{ asset('assets/img/!sample-user.jpg') }}" alt="Joseph Junior"
                                            class="rounded-circle" />
                                    </figure>
                            ...
                            <li>
                                <a href="#" class="clearfix">
                                    <figure class="image">
                                        <img src="{{ asset('assets/img/!sample-user.jpg') }}" alt="Joe Junior"
                                            class="rounded-circle" />
                                    </figure>
