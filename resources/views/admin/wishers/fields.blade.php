...
<div class="form-group col-sm-6">
    ...
    <input type="text" id="phone_no" name="phone_no" value="{{ old('phone_no', $wisher->phone_no ?? '') }}"
        class="form-control" required maxlength="255">
</div>
...
<div class="form-group col-sm-6">
    ...
    <input type="text" id="postcode" name="postcode" value="{{ old('postcode', $wisher->postcode ?? '') }}"
        class="form-control" required maxlength="255">
</div>
