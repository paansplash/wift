...
@section('content')
        <header id="header" class="header-transparent header-effect-shrink"
            ...
            <div class="header-body border-top-0 bg-primary appear-animation"
                                ...
                                <div
                                    ...
                                    <nav class="collapse">
                                        <ul class="nav nav-pills" id="mainNav">
                                            ...
                                            <li><a href="demo-architecture-2-about-us.html" class="nav-link">About</a>
                                            </li>
                                            <li><a href="demo-architecture-2-projects.html"
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li><a href="demo-architecture-2-services-detail.html"
                                                            class="dropdown-item">Design & Planning</a></li>
                                                    <li><a href="demo-architecture-2-services-detail.html"
                                                            class="dropdown-item">Interior Design</a></li>
                                                    <li><a href="demo-architecture-2-services-detail.html"
                                                            class="dropdown-item">Exterior Design</a></li>
                                                    <li><a href="demo-architecture-2-services-detail.html"
                                                            class="dropdown-item">Construction Drawings</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="demo-architecture-2-blog.html" class="nav-link">Blog</a></li>
                                            <li><a href="demo-architecture-2-contact.html"
                                ...
                                <div class="row align-items-center h-100">
                                    <div class="col">
                                        ...
                                        <a href="#start" data-hash data-hash-offset="0" data-hash-offset-lg="140"
                                            ...
                                            data-appear-animation-delay="750">GET STARTED</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-9 col-lg-4 col-xl-5 pb-5 pb-lg-0 mb-5 mb-lg-0">
                                <div class="position-relative">
                                    <img src="assets/img/demos/architecture-2/backgrounds/arch-plan-2.jpg"
                                        class="img-fluid position-absolute left-0 z-index-0 appear-animation"
                                        alt="" data-appear-animation="fadeIn"
                                        data-appear-animation-delay="850" style="bottom: -168px;" />
                    ...
                    <div class="container container-xl-custom py-5 mt-5 mb-4">
                        <div class="row py-4">
                            <div class="col-lg-5 col-xl-4 position-relative mb-4">
                                ...
                                <h3
                                    class="text-transform-none text-color-dark font-weight-black text-9 line-height-2 mb-4">
                                ...
                                <div class="progress-bars custom-progress-bars-style-1">
                                    ...
                                    <div class="progress progress-xs progress-no-border-radius bg-color-grey-300 mb-4">
                                        <div class="progress-bar progress-bar-primary"
                                            data-appear-progress-animation="85%"></div>
                                    </div>
                                    ...
                                    <div class="progress progress-xs progress-no-border-radius bg-color-grey-300 mb-4">
                                        <div class="progress-bar progress-bar-primary"
                                            data-appear-progress-animation="90%"></div>
                                    </div>
                ...
                <section class="section section-height-3 bg-primary border-0 m-0">
                    <div class="container container-xl-custom">
                        <div class="row align-items-center justify-content-center text-center text-xl-start">
                            ...
                            <div class="col-xl-3 text-xl-end appear-animation"
                        ...
                        <ul class="list-unstyled">
                            <li>
                                ...
                                <a href="tel:+1234567890"
                                    class="text-color-light text-6 text-lg-4 text-xl-6 font-weight-bold">800-123-4568</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-md-4 col-lg-2 mb-4 mb-lg-0">
