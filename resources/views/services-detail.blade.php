                            ...
                            <div class="col-md-12 align-self-center p-static text-center">
                                <div class="overflow-hidden mb-2">
                                    <h1 class="font-weight-black text-12 mb-0 appear-animation"
                                        data-appear-animation="maskUp" data-appear-animation-delay="1200">Design & Planning
                                    </h1>
                                </div>
                            </div>
                                            ...
                                            <li class="mb-4">
                                                <strong class="custom-font-secondary text-color-dark text-5">
                                                    <a href="demo-architecture-2-services-detail.html"
                                                        class="custom-link-effect-1 text-color-primary text-decoration-none active">Design
                                                        & Planning</a>
                                                </strong>
                                            </li>
                                            <li class="mb-4">
                                                <strong class="custom-font-secondary text-color-dark text-5">
                                                    <a href="demo-architecture-2-services-detail.html"
                                                        class="custom-link-effect-1 text-color-primary text-decoration-none">Interior
                                                        Design</a>
                                                </strong>
                                            </li>
                                            <li class="mb-4">
                                                <strong class="custom-font-secondary text-color-dark text-5">
                                                    <a href="demo-architecture-2-services-detail.html"
                                                        class="custom-link-effect-1 text-color-primary text-decoration-none">Exterior
                                                        Design</a>
                                                </strong>
                                            </li>
                                            <li class="mb-0">
                                                <strong class="custom-font-secondary text-color-dark text-5">
                                                    <a href="demo-architecture-2-services-detail.html"
                                                        class="custom-link-effect-1 text-color-primary text-decoration-none">Construction
                                                        Drawings</a>
                                                </strong>
                                            </li>
                                        </ul>
