    ...
    <div class="col-9 col-lg-4 col-xl-5 pb-5 pb-lg-0 mb-5 mb-lg-0">
        <div class="position-relative">
            <div class="overflow-hidden position-relative z-index-1">
                <img src="assets/images/backgrounds/1.png" class="img-fluid appear-animation"
                    alt="" data-appear-animation="maskLeft" data-appear-animation-delay="250" />
            </div>
            <div class="overflow-hidden position-absolute z-index-2" style="bottom: -75px; right: -17%;">
                <img src="assets/images/logos/nobg.png" class="img-fluid appear-animation"
                    alt="" data-appear-animation="maskRight" data-appear-animation-delay="550" />
            </div>
        </div>
    </div>
        ...
        <div class="pt-lg-5 ps-lg-5 mt-lg-5">
            ...
            <div class="overflow-hidden mb-3">
                <h3 class="text-transform-none text-color-dark font-weight-black text-10 line-height-2 mb-0 appear-animation"
                    data-appear-animation="maskUp" data-appear-animation-delay="1000">LOVE KNOWS NO BOUNDARIES</h2></h3>
            </div>
            ...
            <p class="custom-font-tertiary text-5 line-height-4 mb-4 appear-animation"
                ...
                Show your love and appreciation without the need to be physically present. Because distance never keep us apart.</p>
            <p class="text-3-5 pb-3 mb-4 appear-animation" data-appear-animation="fadeInUpShorter"
                data-appear-animation-delay="1600">
                Celebrate love from anywhere. Express your heartfelt emotions and connect with your loved ones no matter where you are. True love transcends any distance.</p>
