                ...
                <div class="header-row py-2">
                    <div class="header-column w-100">
                        <div class="header-row justify-content-between">
                            <div class="header-logo z-index-2 col-lg-2 px-0">
                                <a href="index.html">
                                    <img alt="Porto" width="100" height="48" data-sticky-width="82"
                                        data-sticky-height="40" data-sticky-top="84" src="{{ asset('assets/img/logo-default-slim.png') }}">
                                </a>
                            </div>
                            <div
                            ...
                            <ul
                                class="header-extra-info col-auto col-lg-3 col-xl-2 ps-2 ps-xl-0 ms-lg-3 d-none d-lg-block">
                                ...
                                <div class="header-nav-features ps-0 ms-1">
                                    <div
                                        ...
                                        <a href="#" class="header-nav-features-toggle" aria-label="">
                                            <img src="{{ asset('assets/img/icons/icon-cart-big.svg')}}" height="30" alt=""
                                            ...
                                            <ol class="mini-products-list">
                                                <li class="item">
                                                    <a href="#" title="Camera X1000" class="product-image"><img
                                                            src="{{ asset('assets/img/products/product-1.jpg') }}" alt="Camera X1000"></a>
