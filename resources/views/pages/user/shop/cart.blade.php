                                ...
                                <div class="product-thumbnail-wrapper">
                                    ...
                                    <a href="shop-product-sidebar-right.html"
                                        ...
                                        <img width="90" height="90" alt=""
                                            class="img-fluid"
                                            src="{{ asset('assets/img/products/product-grey-1.jpg') }}"> </a>
                                </div>
                            </td>
                        ...
                        <tr class="cart_table_item">
                            <td class="product-thumbnail">
                                <div class="product-thumbnail-wrapper">
                                    ...
                                    <a href="shop-product-sidebar-right.html"
                                        class="product-thumbnail-image" title="Porto Headphone">
                                        <img width="90" height="90" alt=""
                                            class="img-fluid"
                                            src="{{ asset('assets/img/products/product-grey-7.jpg') }}"> </a>
                                </div>
                            </td>
                            <td class="product-name">
                                <a href="shop-product-sidebar-right.html"
                        ...
                        <tr class="cart_table_item">
                            <td class="product-thumbnail">
                                <div class="product-thumbnail-wrapper">
                                    ...
                                    <a href="shop-product-sidebar-right.html"
                                        class="product-thumbnail-image" title="Golf Bag">
                                        <img width="90" height="90" alt=""
                                            class="img-fluid"
                                            src="{{ asset('assets/img/products/product-grey-2.jpg') }}"> </a>
                                </div>
                            </td>
                            <td class="product-name">
                                <a href="shop-product-sidebar-right.html"
                        ...
                        <tr class="cart_table_item">
                            <td class="product-thumbnail">
                                <div class="product-thumbnail-wrapper">
                                    ...
                                    <a href="shop-product-sidebar-right.html"
                                        class="product-thumbnail-image" title="Workout">
                                        <img width="90" height="90" alt=""
                                            class="img-fluid"
                                            src="{{ asset('assets/img/products/product-grey-3.jpg') }}"> </a>
                                </div>
                            </td>
                            <td class="product-name">
                                <a href="shop-product-sidebar-right.html"
                        ...
                        <tr class="cart_table_item">
                            <td class="product-thumbnail">
                                <div class="product-thumbnail-wrapper">
                                    ...
                                    <a href="shop-product-sidebar-right.html"
                                        class="product-thumbnail-image" title="Luxury Bag">
                                        <img width="90" height="90" alt=""
                                            class="img-fluid"
                                            src="{{ asset('assets/img/products/product-grey-4.jpg') }}"> </a>
                                </div>
                            </td>
                            <td class="product-name">
                                <a href="shop-product-sidebar-right.html"
    ...
    <div class="col-lg-4 position-relative">
        <div class="card border-width-3 border-radius-0 border-color-hover-dark" data-plugin-sticky
            ...
            <div class="card-body">
                ...
                <a href="shop-checkout.html" class="btn btn-primary custom-btn-style-1 font-weight-bold text-3 px-5 py-3 m-3">Proceed
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-1.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h3
                                    ...
                                    <a href="shop-product-sidebar-right.html"
                                        class="text-color-dark text-color-hover-primary">Photo
                                        Camera</a>
                                </h3>
                            </div>
                            <a href="#"
                        ...
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image product-thumb-info-image-effect">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-7.jpg') }}"> <img
                                        alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-7-2.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-2.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-3.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-4.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h3
                                    class="text-3-5 font-weight-medium font-alternative text-transform-none line-height-3 mb-0">
                                    <a href="shop-product-sidebar-right.html"
                                        class="text-color-dark text-color-hover-primary">Luxury
                                        Bag</a>
                                </h3>
                            </div>
                            <a href="#"
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-5.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h3
                                    class="text-3-5 font-weight-medium font-alternative text-transform-none line-height-3 mb-0">
                                    <a href="shop-product-sidebar-right.html"
                                        class="text-color-dark text-color-hover-primary">Styled
                                        Bag</a>
                                </h3>
                            </div>
                            <a href="#"
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-6.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-8.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="product mb-0">
                        <div class="product-thumb-info border-0 mb-3">
                            ...
                            <a href="shop-product-sidebar-left.html">
                                <div class="product-thumb-info-image">
                                    <img alt="" class="img-fluid"
                                        src="{{ asset('assets/img/products/product-grey-9.jpg') }}">
                                </div>
                            </a>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h3
                                    class="text-3-5 font-weight-medium font-alternative text-transform-none line-height-3 mb-0">
                                    <a href="shop-product-sidebar-right.html"
                                        class="text-color-dark text-color-hover-primary">Baseball
                                        Ball</a>
                                </h3>
                            </div>
                            <a href="#"
